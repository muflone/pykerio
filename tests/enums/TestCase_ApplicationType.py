...
class TestCase_ApplicationType(unittest.TestCase):
    def test_00_ApplicationType_ApplicationWebFilterCategory(self):
        ...
        self.assertEquals(value.dump(), 'ApplicationWebFilterCategory')
        self.assertEquals(value.get_name(), 'ApplicationWebFilterCategory')
    ...
    def test_01_ApplicationType_ApplicationProtocol(self):
        ...
        self.assertEquals(value.dump(), 'ApplicationProtocol')
        self.assertEquals(value.get_name(), 'ApplicationProtocol')
