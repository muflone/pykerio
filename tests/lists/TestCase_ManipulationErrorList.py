...
class TestCase_ManipulationErrorList(unittest.TestCase):
    def test_01_ManipulationErrorList(self):
        """
        Test ManipulationErrorList
        """
        testlist = pykerio.lists.ManipulationErrorList()
