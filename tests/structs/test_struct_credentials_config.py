...
class TestCase_CredentialsConfig(unittest.TestCase):
    def test_01_CredentialsConfig(self):
        ...
        self.assertEqual(teststruct['userName'], pykerio.constants.APP_AUTHOR)
        self.assertEqual(teststruct['password'], password)
        self.assertEqual(teststruct['passwordChanged'], False)
