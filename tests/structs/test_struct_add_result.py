...
class TestCase_AddResult(unittest.TestCase):
    def test_01_AddResult(self):
        """
        Test AddResult
        """
        ...
        self.assertEqual(teststruct['success'], False)
        self.assertEqual(teststruct['errorMessage'], errormessage)
