...
class TestCase_FilenameGroups(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        """
        Prepares session
        ...
        # Ports
        cls.groups = pykerio.interfaces.FilenameGroups(api)
    ...
    def test_01_get(self):
        ...
        for group in groups_list:
            self.assertEquals(type(group), pykerio.structs.FilenameGroup)
